...
const EventCoordController = {
    addEventCoordinator: async (req, res) => {
        try {
            ...
            const response = await EventCoordModule.addEventCoordinator(
                eventID,
                CoordinationRole,
                StudentID,
                Hours
    ...
    updateEventCoordinator: async (req, res) => {
        try {
            const { eventID, CoordinationRole, StudentID, Hours } = req.body;
            const response = await EventCoordModule.updateEventCoordinator(
                eventID,
                CoordinationRole,
                StudentID,
                Hours
    ...
    deleteEventCoordinator: async (req, res) => {
        try {
            ...
            const response = await EventCoordModule.deleteEventCoordinator(
                eventID,
                StudentID
            );
            return res
